...
public class Blog4 extends JFrame{
	private String one;
	private String two;
	public JLabel first = new JLabel();
	public JLabel second = new JLabel();
	...
	public void timeget() {//시간관련
		...
		while(true) {//무조건 실행
			...
			one= (year+"."+month+1+"."+date+"."+sday+" day");//one이라는 문자열에 저장
